export default {
    ...
    comp:{
        chosenScreen: 'Select the location screen',
        cancel: 'Cancel',
        submit: 'Confirm',
        submitMsg:'Confirm',
    ...
    toast: {
        // groupOk:'screen group changed successfully',
        groupOk:'Publish successfully',
    ...
    cropper:{
        ...
        chosen:'Please select a picture',
        photo: 'Select from the album',
        carmer: 'Photograph'
    },
    scan: {
        text: "QR code data is",
        title: "Pay the qr code or barcode into the scenic frame, and you can scan automatically",
        tips: "The prompt text of the page screen",
        light: "Touch",
        album: "Album",
        cancel: "User cancel selection",
    ...
    placeholder: {
        ...
        ssid: "Please enter the new ssid",
        emptyHost: 'No ap host, please add first',
        emptyAuthor: 'No host authorized',
        ...
        sqTips:'This host has been bound by the owner. if you want to continue to use it, please click below for authorization.',
        owner:'Owner',
    ...
    btn: {
        ...
        cancel: "Cancel",
        cancelAuthor: "Cancel Authorization",
        author: "Confirm",
        apply: "Confirm",
        accept: "Accept",
        ok:'Confirm',
    ...
    index: {
        ...
        menu: {
            menu1: {
                title: "Upload to a single Screen",
                desc: "Screen configuration and screen mode",
            },
            menu2: {
                title: "Scene Upload",
                desc: "More ways to edit and add scene",
            },
            menu3: {
                title: "AP Host Settings",
                desc: "Host -related settings",
            },
            menu4: {
                title: "Host Authorized",
                desc: "Host authorized related settings",
            },
        },
        btnAction: {
            timer: "Running time",
            screenNum: "No. of screens",
            model: "Model",
            cjNum:'No. of scenes'
        },
    },
    ...
    commonlyUsed:{
        ...
        outline: "Offline",
        screens: 'Screens',
        stopRunning: 'Out of service'
    },
    hostSettingMenu:{
        SSIDSettings : 'SSID Settings',
        ScreenSettings : 'Display Setting',
        PatternSettings : 'Mode Settings',
        Unbind: 'Need Verification',
        modalTitle: 'Need verificatio ap host',
        modalText: 'If you unbind the host, you will need to reconnect by scanning qr code. are you sure you want to disconnect?',
        confirmText: 'Need verification',
        unBindOk:'Verfied ok',
        unBindFail:'Verfied failure',
    },
    hostSettingSsid:{
        OnlineScreen : 'Screen online',
    ...
    sceneUpload: {
        nav: 'Scene list',
		navScreen:'Screen list',
        sceneReset:"Reset",
        empty:"No scene available",
        addNow:"Add now",
        online:"Screen online",
        max:"Screen maximum",
        onlineNumber:" Number of screens online:",
        addScene:"Add A Scene",
        confirmText:"Resetting scenes will delete all scenes permanently, please confirm",
    ...
    author:{
        frindsRefuse:'Refuse To Apply',
        frindsAgreen:'Acceptance',
        frindsMessage:'Friend requests',
        frindsAgreenBtn:'Acceptance',
        frindsRefuseBtn:'Refuse',
        refuse:'Refusal Of Authorization',
        agreen:'Accept Authorization',
        cancel:'Delete',
        refuseBtn:'Confirm',
        agreenBtn:'Confirm',
        cancelBtn:'Confirm',
        agreenStr:'Whether to accept users or not',
        cancelStr:'Whether to cancel the user',
        ids:'The id for the host is',
        idss:'Application for authorization of',
        refuseStr:'Whether to reject the user',
        sq:'Authorization of'
    },
    area:'Country',
    china:'China',
